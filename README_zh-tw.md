...
# 資源彙集
## 書籍
* [第一本Docker書](http://book.douban.com/subject/26285268/) (7.4分)
* [Docker —— 從入門到實踐](http://yeasy.gitbooks.io/docker_practice/content/) (內容一般)
...
* [Docker 技術入門與實戰](http://book.douban.com/subject/26284823/) (6.1分)
* [Docker源碼分析](http://book.douban.com/subject/26581184/)
* [Docker——容器與容器雲](http://book.douban.com/subject/26593175/)
...
* [Docker開發實踐](http://book.douban.com/subject/26432893/)
...
## 內容聚合
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) (英文docker資源匯總)
...
* [靈雀雲部落格](http://www.alauda.cn/blog/)
...
## 創業公司
* [雲雀科技](https://www.alauda.cn)
* [DaoCloud](https://www.daocloud.io/)
* [雲棧科技](https://csphere.cn)
* [tutum](https://www.tutum.co/)
* [時速雲](https://www.tenxcloud.com/)
* [數人科技](http://www.dataman-inc.com/)
* [網易蜂巢](https://c.163.com/)
* [好雨雲](https://www.goodrain.com/)
...
* [bocker](https://github.com/p8952/bocker) (100行bash實現的docker)
* [lxd](https://github.com/lxc/lxd)(Daemon based on liblxc offering a REST API to manage containers)

## 管理工具
* [kubernetes](https://github.com/GoogleCloudPlatform/kubernetes) (最有可能成為事實標準的一個，已經獲得諸多平台支援)
* [shipyard](https://github.com/shipyard/shipyard)  (帶GUI)
* [swarm](https://github.com/docker/swarm) (官方出品，尚在初期)
* [citadel](https://github.com/citadel/citadel) (用於創建管理工具的tookit,shipyard即是基於此開發)
* [docker-cluster](https://github.com/tsuru/docker-cluster) (使用`Docker remote api`)
* [compose](https://github.com/docker/compose) (Define and run complex applications using Docker.原來的Fig)
...
* [fleet] (https://github.com/coreos/fleet) (將systemd的能力擴展到多個機器)
...
* [cSphere](https://csphere.cn/) (容器虛擬化管理平台,提供可視化介面，容器、鏡像、機器、倉庫等管理。商業軟體，有試用版)
...
## 服務發現
* [skydock](https://github.com/crosbymichael/skydock) (基於DNS)
...
* [Kitematic](https://kitematic.com/) (現在包含在Docker Toolbox中，支援Mac OS X 10.8+ 和 Windows 7+ (64-bit) )
...
* [portainer](http://portainer.io/) (簡單的UI管理工具)
* [Swirl](https://github.com/cuigh/swirl) (專註於 Swarm 集群的 Docker 管理工具)
...
## 應用
* [ferry](https://github.com/cirruspath/ferry) (使用docker來構建部署大數據應用(hadoop,spark...),[ferry.opencore.io](http://ferry.opencore.io/))
...
* [Wordpress+Nginx](https://github.com/eugeneware/docker-wordpress-nginx) (A
  ...
  wordpress [image](https://github.com/jbfink/docker-wordpress)) 另一個[wordpress](https://github.com/dz0ny/docker-wpdev)
...
* [Docker 筆記](http://opskumu.github.io/docker.html) 
* [關於Docker你應該知道的10件事](http://www.lupaworld.com/portal.php?mod=view&aid=250966)
* [Docker的大坑小窪](http://blog.daocloud.io/docker_troubleshootings/) / [再談《Docker的大坑小窪》](http://dockerone.com/question/92)
...
* [深入Docker存儲驅動](http://static.dockerone.com/ppt/filedriver.html#1) (slide)
...
### 資源管理
* [Resource management in Docker](https://goldmann.pl/blog/2014/09/11/resource-management-in-docker/) (與systemd有關)
...
* [Docker部署基於Ryu的SDN環境](http://www.csdn.net/article/2014-12-05/2822974)
...
* [Docker intercontainer networking explained](http://blog.sequenceiq.com/blog/2014/08/12/docker-networking/)
* [從SDN以及Docker看網路模型發生的變革](http://dockerone.com/article/188) ([English](http://thenewstack.io/sdn-docker-real-changes-ahead/))
...
* [Java開發人員需要注意的五大Docker誤區](http://dockerone.com/article/236) ([English](http://blog.takipi.com/ignore-the-hype-5-docker-misconceptions-java-developers-should-consider/))
...
* [Linux Containers](https://wiki.archlinux.org/index.php/Linux_Containers) (archwiki上的內容)

### cgroups
* [cgroups](https://www.kernel.org/doc/Documentation/cgroups/cgroups.txt) (內核官方文檔)
* [Managing system resources on Red Hat Enterprise Linux 6](https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/6/html-single/Resource_Management_Guide/index.html) (推薦）
* [Cgroups](https://wiki.archlinux.org/index.php/cgroups) (archwiki上的內容)
...
### Swarm
* [剖析Docker Swarm和Mesos：是什麼？如何結合？有什麼優勢？](http://dockerone.com/article/213) ([English](http://mesosphere.com/2015/02/26/deploying-with-docker-swarm/))
...
* [Docker Swarm入門（一）概觀](http://dockerone.com/article/168) / [(二）配置選項與基本運行環境要求](http://dockerone.com/article/178) / [（三）Swarm SOA舉例](http://dockerone.com/article/192) / [（四）Demo](http://dockerone.com/article/203)
...
* [基於Kubernetes構建Docker集群管理詳解](http://www.csdn.net/article/2014-12-24/2823292-Docker-Kubernetes)
...
* [Mesos vs OpenStack?誰才是私有雲的未來](http://dockerone.com/article/224) ([English](http://www.quora.com/What-is-the-future-of-the-private-cloud-world-Mesos-or-OpenStack?from=timeline&isappinstalled=0))
...
* [Windows Docker內部原理猜想](http://weibo.com/p/1001603824898261799110)
...
* [Docker實戰：更輕鬆、更愉快、更高效](http://dockerone.com/article/217) ([English](https://realpython.com/blog/python/docker-in-action-fitter-happier-more-productive/))
...
* [減少使用Java應用伺服器，迎接Docker容器](http://dockerone.com/article/267) ([English](https://medium.com/@jstrachan/the-decline-of-java-application-servers-when-using-docker-containers-edbe032e1f30))
...
* [大規模Docker集群助力微博迎接春晚峰值挑戰](http://weibo.com/p/1001603811301997572906)
* [Docker在春晚中的實際表現](http://weibo.com/p/1001603816339658657489)
* [Docker系列之二：基於容器的自動構建](http://tech.meituan.com/autobuild.html) (美團)
* [Mesos在去哪兒網的應用](http://dockone.io/article/675)
